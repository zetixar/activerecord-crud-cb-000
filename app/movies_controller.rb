...
def can_be_found_updated_and_saved
  ...
  Movie.find_by(title: "Awesome Flick").update_attributes(:title => "Even Awesomer Flick")
end

def can_update_using_update_method
  # Update movie title to "Wat, huh?"
  Movie.create(title: "Wat?").update_attributes(:title => "Wat, huh?")
end
...
def can_update_multiple_items_at_once
  ...
  Movie.all.each { |movie| movie.update_attributes(:title => "A Movie") }
end
